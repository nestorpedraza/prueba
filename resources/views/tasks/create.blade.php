    ...
    <div class="container-xxl flex-grow-1 container-p-y">
       ...
       <div class="row">
           ...
           <div class="demo-inline-spacing">
               <a type="button" href="{{ url('/taskindex/'.$proyecto->id) }}" class="btn btn-secondary">Regresar</a>
           </div>
         <!-- Basic Layout -->
         <div class="col-xxl">
           <div class="card mb-4">
            <h5 class="card-header">Proyecto: {{$proyecto->titulo}}</h5>
             <div class="card-header d-flex align-items-center justify-content-between">
               <h5 class="mb-0">Crear Tarea</h5>
               <small class="text-muted float-end">Datos</small>
             </div>
             <div class="card-body">
               <form method="POST" action="{{ route('tasks.store') }}">
                 @csrf
                 <input type="hidden" class="form-control" id="proyect_id" name="proyect_id"  value="{{$proyecto->id}}"/>
                   <div class="row mb-3">
