<x-layout-backend>
 ...
 <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Proyectos/</span> Editar</h4>
    ...
    <div class="row">
      ...
      <div class="col-xxl">
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="POST" action="{{ route('proyects.update', ['id' => $proyecto->id]) }}">
              @csrf
                <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="titulo">Titulo</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Nombre del proyecto" value="{{$proyecto->titulo}}" required/>
                  @error('titulo')
